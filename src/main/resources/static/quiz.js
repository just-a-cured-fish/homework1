(function($) {
    $.fn.jquizzy = function(settings) {
        ...
        superContainer2 = $("#quiz-container2"),
        answers = [],
        ...
        superContainer2.addClass('main-quiz-holder');
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
           // contentFob += '<div class="slide-container"><div class="question-number">' + (questionsIteratorIndex + 1) + '/' + config.questions.length + '</div><div class="question">' + config.questions[questionsIteratorIndex].question + '</div><ul class="answers">';
            contentFob += '<div class="slide-container" ><div class="question-number">' + (questionsIteratorIndex + 1) + '/' + config.questions.length + '</div><div class="question" id="ques">'
                + '&nbsp'+config.questions[questionsIteratorIndex].question
               ;

                contentFob+='<div class="pro" style="display: none" >';
                for (answersIteratorIndex = 0; answersIteratorIndex < config.questions[questionsIteratorIndex].process.length; answersIteratorIndex++) {
                    contentFob += '<p>' +"= "+ config.questions[questionsIteratorIndex].process[answersIteratorIndex] + '</p>';
                }
                contentFob+='</div>';

            contentFob+= '</div><ul class="answers">'
            //  contentFob2 += '<div class="slide-container"><div class="question-number">' + (questionsIteratorIndex + 1) + '/' + config.questions.length + '</div><div class="question">' + config.questions[questionsIteratorIndex].question + '</div><ul class="answers">';
        ...
        superContainer.find('.final').click(function() {
            ...
            toLoopTill = results.length; i < toLoopTill; i++) {
                ...
                for (answersIteratorIndex = 0; answersIteratorIndex < config.questions[i].answers.length; answersIteratorIndex++) {
                    ...
                    resultSet += '<li class="' + classestoAdd + '" style="' + color + '">' + config.questions[i].answers[answersIteratorIndex] + '</li>';
                }
